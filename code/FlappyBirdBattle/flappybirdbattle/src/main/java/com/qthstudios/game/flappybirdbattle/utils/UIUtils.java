...
import com.qthstudios.game.flappybirdbattle.BuildConfig;
import com.qthstudios.game.flappybirdbattle.screen.BunnyApplication;
import com.qthstudios.game.flappybirdbattle.utils.LogUtils;
...
public class UIUtils {
    ...
    public static final String TARGET_FORM_FACTOR_ACTIVITY_METADATA =
            "com.hac.android.TARGET_FORM_FACTOR";
    ...
    */
    ...
    public static void enableDisableActivitiesByFormFactor(Context context) {
        ...
        try {
            ...
            LogUtils.LOGE(TAG, "Activity not found within package.", e);
        }
    }
    ...
    public static void releaseOrientationLock(Activity activity) {
